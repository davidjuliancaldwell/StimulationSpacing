function [subtracted_sig_matrixS_I, subtracted_sig_cellS_I,recon_artifact_matrix,recon_artifact,t] =  ica_artifact_remove(tTotal,data,stimChans,pre,post,fs_data,scale_factor,numComponentsSearch,plotIt,channelInt)
...
stimChan1 = stimChans(1);
stimChan2= stimChans(2);
